...
import org.stepik.plugin.modules.Submission;
...
public class SendFile extends PopupMenuAction {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        String attemptId = StepikConnector.getAttemptId(stepId, project);
        String submissionId = StepikConnector.sendFile(text, attemptId, project);
                ...
                () -> {
                    ...
                    while (ans.equals("evaluation") && count < 100) {
                        try {
                            ...
                            list = StepikConnector.getStatus(finalSubmissionId, project);
                            if (list != null) {
